...
📊 <b>File Stats:</b>
━━━━━━━━━━━━━━━━━━━━━━━
❓ Total questions in file: <b>${result.questionCount} / 50</b>
━━━━━━━━━━━━━━━━━━━━━━━
🔍 <b>Answer Match Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Answers matched:      <b>${sfgSt.matched ?? '?'}</b>
❌ Answers missing:      <b>${sfgSt.noAns ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📝 <b>Explanation Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Explanations found:   <b>${sfgSt.explanationsFound ?? '?'}</b>
⚠️ Explanations missing: <b>${sfgSt.noExpl ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📄 Lines: <b>${result.lineCount}</b> | 📦 Size: <b>${(outputBuffer.length / 1024).toFixed(1)} KB</b>${result.questionCount < 50 ? '\n\n⚠️ <i>Expected 50 questions — got ' + result.questionCount + '. Some Q may be missing.</i>' : ''}`,
      { reply_markup: backKeyboard() }
    );
...
📊 <b>File Stats:</b>
━━━━━━━━━━━━━━━━━━━━━━━
❓ Total questions in file: <b>${result.questionCount} / 100</b>
━━━━━━━━━━━━━━━━━━━━━━━
🔍 <b>Answer Match Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Answers matched:      <b>${vajSt.matched ?? '?'}</b>
❌ Answers missing:      <b>${vajSt.noAns ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📝 <b>Explanation Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Explanations found:   <b>${vajSt.explanationsFound ?? '?'}</b>
⚠️ Explanations missing: <b>${vajSt.noExpl ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📄 Lines: <b>${result.lineCount}</b> | 📦 Size: <b>${(outputBuffer.length / 1024).toFixed(1)} KB</b>`,
        { reply_markup: backKeyboard() }
      );
...
🔍 <b>Answer Match Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Answers matched:      <b>${visSt.matched ?? '?'}</b>
❌ Answers missing:      <b>${visSt.noAns ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📝 <b>Explanation Report:</b>
━━━━━━━━━━━━━━━━━━━━━━━
✅ Explanations found:   <b>${visSt.explanationsFound ?? '?'}</b>
⚠️ Explanations missing: <b>${visSt.noExpl ?? '?'}</b>
━━━━━━━━━━━━━━━━━━━━━━━
📄 Lines: <b>${result.lineCount}</b> | 📦 Size: <b>${(outputBuffer.length / 1024).toFixed(1)} KB</b>`,
        { reply_markup: backKeyboard() }
      );
